...
import AllHiredBookings from "./AllHiredBookings";
    ...
    <div className={Styles.ProfilePannel}>
      <div className={Styles.leftPart}>
        <ul className={Styles.leftPannel}>
          ...
          <li
            className={Styles.leftPannel_eachListOption}
            onClick={() => handleListItemClick("allBookings")}
          >
            <BiPin style={{ color: "grey", fontSize: "30px" }} />
            <div className={Styles.leftPannel_eachListItem_text}>All Bookings</div>
          </li>
          <div className={Styles.line}></div>
          <li
            className={Styles.leftPannel_eachListOption}
            onClick={() => handleListItemClick("allHiredBookings")}
          >
            <BiPin style={{ color: "grey", fontSize: "30px" }} />
            <div className={Styles.leftPannel_eachListItem_text}>All Hired Bookings</div>
          </li>
          {/* <div className={Styles.line}></div>
      ...
      {selectedItem === "allBookings" ? <AllBookings /> : null}
      {selectedItem === "allHiredBookings" ? <AllHiredBookings /> : null}
